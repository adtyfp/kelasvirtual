    ...
    <div class="faq-container">
        ...
        <div class="faq-card main-faq-card">
            <div class="faq-header" onclick="toggleDropdown('infoDropdown')">
                <span><i class="fas fa-box-open icon-produk"></i> Produk</span>
                <span class="arrow" id="infoArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="infoDropdown">
                <a href="faq-informasi.php"><i class="fas fa-circle-info icon-info"></i></i> Informasi Umum</a>
        ...
        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('registrasiDropdown')">
                <span>Yang sering ditanyakan terkait Produk</span>
                <span class="arrow" id="registrasiArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="registrasiDropdown">
                <a href="faq-registrasi-1.php">Cara membeli produk</a>
                <a href="faq-registrasi-2.php">Ada apa saja di produk</a>
            </div>
        </div>
        ...
        <div class="faq-card">
            ...
            <div class="faq-dropdown" id="produkDropdown">
                <a href="faq-produk-1.php">Paket Bulanan</a>
                <a href="faq-produk-2.php">Paket Tahunan</a>
            </div>
        </div>

        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('pesanDropdown')">
                <span>Kelas Individu</span>
                <span class="arrow" id="pesanArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="pesanDropdown">
                <a href="faq-pesan-1.php">Desain Grafis Dasar</a>
                <a href="faq-pesan-2.php">public Speaking & Komunikasi</a>
            </div>
        </div>

        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('danaDropdown')">
                <span>E-BOOK & Modul</span>
                <span class="arrow" id="danaArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="danaDropdown">
                <a href="faq-dana-1.php">E-Book Tematik</a>
                <a href="faq-dana-2.php">Modul Kursus</a>
            </div>
        </div>
        ...
        <div class="faq-card">
            ...
            <div class="faq-dropdown" id="aduanDropdown">
                <a href="faq-aduan-1.php">Mini Workshop</a>
                <a href="faq-aduan-2.php">Webinar Umum</a>
            </div>
        </div>
    </div>
