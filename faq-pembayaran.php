    ...
    <div class="faq-container">
        ...
        <div class="faq-card main-faq-card">
            <div class="faq-header" onclick="toggleDropdown('infoDropdown')">
                <span><i class="fas fa-credit-card icon-pembayaran"></i> Pembayaran</a></span>
            ...
            <div class="faq-dropdown" id="infoDropdown">
                ...
                <a href="faq-produk.php"><i class="fas fa-box-open icon-produk"></i> Produk
        ...
        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('registrasiDropdown')">
                <span>Yang sering ditanyakan terkait Pembayaran</span>
                <span class="arrow" id="registrasiArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="registrasiDropdown">
                <a href="faq-registrasi-1.php">Cara Membayar</a>
                <a href="faq-registrasi-2.php">Bagaimana jika pembayaran gagal</a>
                <a href="faq-registrasi-2.php">Apakah uang bisa kembali</a>
            </div>
        </div>

        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('produkDropdown')">
                <span>Metode Pembayaran Yang Tersedia</span>
