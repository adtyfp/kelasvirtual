    ...
    <div class="faq-container">
        ...
        <div class="faq-card main-faq-card">
            <div class="faq-header" onclick="toggleDropdown('infoDropdown')">
                <span><i class="fas fa-handshake icon-program"></i> Program Kelas Virtual</span>
        ...
        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('registrasiDropdown')">
                <span>Yang sering ditanyakan terkait Program</span>
                <span class="arrow" id="registrasiArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="registrasiDropdown">
                <a href="faq-registrasi-1.php">Kupon Diskon</a>
                <a href="faq-registrasi-2.php">Cashback</a>
                <a href="faq-registrasi-2.php">12.12</a>
            </div>
        </div>

        <div class="faq-card">
            <div class="faq-header" onclick="toggleDropdown('produkDropdown')">
                <span>Siapa saja yang bisa bergabung dengan Program Kelas Virtual</span>
                <span class="arrow" id="produkArrow">⌄</span>
            </div>
            <div class="faq-dropdown" id="produkDropdown">
                <a href="#">mahasiswa</a>
                <a href="#">Dosen</a>
                <a href="#">Influencer edukasi</a>
                <a href="#">Siapa pun yang memiliki komunitas atau jejaring aktif di bidang pendidikan</a>
            </div>
        </div>
    </div>
