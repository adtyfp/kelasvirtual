...
// koneksi
$koneksi = new mysqli("mysql.railway.internal", "root", "BzqBvkxgNYrBiaaQClzRvJvsRPXfKvyz", "railway");
...
<body>
    ...
    <nav class="bottom-nav">
        ...
        <div class="nav-logo-wrapper"><a href="index.php" class="nav-logo"><img src="asset/kelas.png"
                    alt="Kelas Virtual"></a></div>
